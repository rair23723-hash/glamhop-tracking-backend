        ...
        const response = await axios.get(
            `https://${SHOPIFY_SHOP_DOMAIN}/admin/api/2024-07/orders.json`,
            {
                ...
                params: {
                    name: `#${cleanNumber}`,
                    status: 'any',
                    fields: 'id,name,email,fulfillment_status,fulfillments,line_items,created_at,financial_status,shipping_address',
                },
                timeout: 10000,
            }
        );
...
/**
 * Look up an order by order number name alone (without email filter).
 */
...
module.exports = { getOrderByNumberAndEmail, getOrderByNumber, extractAWBFromOrder };
